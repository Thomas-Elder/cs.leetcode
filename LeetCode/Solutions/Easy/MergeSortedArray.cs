...
{
    /// <summary>
    /// A class for solving leetcode problem 88. Merge Sorted Array
    /// </summary>
    ...
    public class MergeSortedArray
    {
        ...
        /// <summary>
        /// Returns an array with the same elements as passed, but shifted right from the given index
        /// </summary>
        /// <returns></returns>
        public int [] Scootch(int [] input, int index)
        {
